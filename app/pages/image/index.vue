      ...
      <UContainer>
        <div class="max-w-2xl">
          ...
          <h1 class="text-4xl md:text-5xl font-bold text-white tracking-tight mb-4">
            Image <span class="text-primary-500">Studio</span> Playground
          </h1>
          <p class="text-lg text-neutral-400 leading-relaxed">
            A comprehensive suite of high-performance image tools featuring professional cropping,
            censoring, and annotation capabilities for modern web applications.
          </p>
        </div>
      </UContainer>
    </div>
